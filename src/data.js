...
var Sample = {
  ...
  names: ['蔡英文', '黃國昌', '范雲', '楊智達'],
  jobTitle: ['總統', '主席', '立法委員', '候選人', '宅宅'],
  youtubeID: ['4BfxvvbVYWQ', 'THHQzPKuXzI', 'TdtXso7GB_s', 'ADxzZk9wzDk'],
  partner: ['FGT! 體育改革聯會', '自由時報', 'Google'],
}
var Factory = (function Factory() {
  this.event = function(options) {
    ...
    options.numberOf.partners = options.numberOf.partners || randomInt(1, 2);
    var partners = [];
